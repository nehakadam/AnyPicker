...
var documentation = {
    ...
    [
        ...
        },
        {
            ...
            "parameters": "<ul>\n  <li>Button Type</li>\n</ul>",
            "returnvalue": "",
            "description": "Called when any of the button on AnyPicker UI is clicked. Button Type is used to identify button clicked. Value of Button Type can be \"set\", \"clear\", \"cancel\" or \"now\"."
        },
        {
            "name": "parseInput",
            "tags": ["Basic"],
